...
Для отдельных копий `review_3d`, `repeat_10d`, `comeback_3d` без футера см.
[точечное копирование нейтральных шаблонов](meta-template-neutral-cloning.md).
Обычный запуск ниже такие исходники по-прежнему пропускает.
